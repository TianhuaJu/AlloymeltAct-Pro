...
{
    public partial class ActivityCoefficientPanel : UserControl
    {
        public string PageTitle => "Activity Coefficient";

        public ActivityCoefficientPanel()
        {
            InitializeComponent();
        }
        ...
        private Dictionary<string, double> get_Compositions(string solv, string alloyComposition)
        {
            ...
            foreach (Match match in matchs)
            {
                ...
                if (compo_dict.ContainsKey(A)) compo_dict[A] = x;
                else compo_dict.Add(A, x);
            }
